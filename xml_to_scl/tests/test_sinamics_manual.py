"""
Test script for FB/FC parser with SinamicsCU.xml
"""
...
def test_sinamics_parser():
    """Test FB parser with SinamicsCU.xml"""
    
    setup_logging()
    
    # Path to test file
    test_file = Path(r"c:\Projects\MODULBLOCK_MBK2\MBK_2\PLC_410D1\Software units\1_Orchestrator_Safety\Program blocks\001_StdBlocks\002_Device\SinamicsCU\SinamicsCU.xml")
