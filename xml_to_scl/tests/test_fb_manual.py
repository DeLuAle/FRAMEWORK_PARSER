...
def test_fb_parser():
    """Test FB parser with F_Estop_FB.xml"""
    ...
    try:
        ...
        print("\nGenerated SCL code:")
        print("=" * 70)
        print(scl_code[:1000])  # First 1000 chars
        print("..." if len(scl_code) > 1000 else "")
        print("=" * 70)
